...
const DetailLayananComponent = ({ selectedLayanan }) => {
  const layananItems = [
    {
      id: "rekomendasi",
      title: "Rekomendasi",
      ...
      description:
        "Pelaksanaan rencana dan anggaran Sistem Pemerintahan Berbasis Elektronik oleh Organisasi Perangkat Daerah di lingkungan Pemerintah Daerah Istimewa Yogyakarta wajib disertai Rekomendasi Teknis Pelaksanaan Sistem Pemerintahan Berbasis Elektronik Pemerintah Daerah Daerah Istimewa Yogyakarta. Rekomendasi diajukan oleh Organisasi Perangkat Daerah kepada Dinas Komunikasi dan Informatika Provinsi Yogyakarta.",
      steps: [
        {
          title:
            "OPD melakukan pengajuan permohonan rekomendasi pelaksanaan investasi TIK kepada Kepala Dinas Komunikasi dan Informatika DIY pada n-1 tahun anggaran. Di dalam permohonan rekomendasi pelaksanaan investasi TIK, OPD menyertakan:",
          substeps: [
            "analisis kebutuhan;",
            "analisis biaya; dan",
        ...
        {
          title:
            "Dinas Komunikasi dan Informatika mengevaluasi permohonan rekomendasi pelaksanaan investasi TIK dengan mengacu pada Renstra TIK.",
          substeps: [],
        },
        {
          title:
            "Berdasarkan hasil analisis sebagaimana dimaksud pada tahap 2, Dinas Komunikasi dan Informatika:",
          substeps: ["memberikan rekomendasi; atau", "menolak permohonan."],
        },
        {
          title:
            "Apabila permohonan rekomendasi ditolak, OPD melakukan penyesuaian atas pelaksanaan investasi TIK dalam rencana kerja anggaran sesuai saran Dinas Komunikasi dan Informatika.",
          substeps: [],
        },
      ],
    },
    {
      ...
      title: "Subdomain",
      bgStyle: {
        backgroundImage: "linear-gradient(to right, #FFFFFF, #fde68a)",
      },
      icon: <FaGlobe className="text-white" />,
      description:
        "Diskominfo DIY menyediakan layanan subdomain *.jogjaprov.go.id bagi OPD dan stakeholder Pemda DIY. Subdomain merupakan nama unik pengganti alamat IP untuk mempermudah mengakses alamat suatu Sistem Elektronik. Subdomain *.jogjaprov.go.id menunjukkan bahwa Sistem Elektronik tersebut dikelola oleh Pemda DIY.",
      steps: [],
    },
    {
      id: "hosting",
    ...
    <div className="container py-4">
      {layananItems.map((item) => (
        <div
          ...
          ref={(el) => {
            if (el) {
              layananRefs.current[item.id] = el;
            }
          }}
        ...
        >
          <div className="card-body">
            ...
            <div className="mt-3">
              <button className="btn btn-primary">Ajukan Sekarang</button>
            </div>
          </div>
        </div>
      ))}
